...
import { NameConfiguration } from '../components/order/NameConfig';
...
export default function Home() {
  ...
  const handleAddName = (name: string, defaultSoySauce: boolean) => {
    setNameConfigs(prev => [...prev, { name, defaultSoySauce }]);
  };
          ...
          <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-5xl">
            ...
            {isConfiguring && (
              <NameConfiguration
                ...
                onUpdatePreference={handleUpdateNamePreference}
              />
            )}
